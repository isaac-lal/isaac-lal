...
[![My Skills](https://skillicons.dev/icons?i=html,css,javascript,typescript,react,vite,nextjs,tailwindcss,sass,mongodb,postgresql,express,nodejs,git,vscode,vercel)](https://skillicons.dev)
